...
(function() {
  ...
  // adding eventlisteners at this point didn't work. 
  // The clones of the template don't exist yet
  /*
  const closebuttons = document.getElementsByClassName('closebuttonspan');
  console.log(["cbArray",cbArray.length]);
  ...
  */
  ...
  app.updateForecasts = function() {
    console.log("app.updateforcasts called");
